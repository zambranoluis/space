...
const History = () => {
  ...
  return (
    <div className="flex flex-col w-[90%] place-self-center bgred-200  gap-2 ">
      ...
      <div className="flex flex-col    w-full bgblue-400 place-self-center rounded-md border border-[#6b776d] ">
        <div className="w-full    flex justify-center p-2 py6 items-center  border-b border-b-[#6b776d] bgblue-400 gap-2">
          {/* <div className="flex p-2 bg[--color-button]  rounded-md   text-[#6b776d] hover:text-[#848d5a] cursor-pointer">
        ...
        <div className="grid overflow-y-scroll  max-h-[360px] placecontent-center  place-items-center sm:grid-cols-2 lg:grid-cols-3  p-2 py-4 gap-6 w-full   bgred-600">
          {
            clientsTest.map((client) => (
              <Card className='w-full max-w-[350px] h-[150px] p-4 bg-white border border-[#6b776d]' key={client.id}>
                ...
                <CardFooter className='flex justify-end  bgblue-400 gap-2  '>
                  <Tooltip content="View Assistance Calendar">
                    <div className='flex hover:text-[--color-button-text-hover]  text-[--color-button-text]  bggreen-400 cursor-pointer bg[--color-button] hover:bgbg[--color-button-hover] p-2 rounded-md border border-[--color-border]'>
