    ...
    >
      <div className='relative w-full h-full'>
        <div className='absolute w-full h-full gap-8 flex flex-col'>
          <div
            id='siteContainer'
            className={`bg-red-400 transition-all duration-300 overflow-hidden absolute w-full h-full bg-red-300 flex max-md:pl-12 md:justify-center items-center`}
          >
            <div className='max-md:w-[90%] w-[80%] h-[70%] flex bg-white rounded-3xl shadow-md shadow-black'>
              <div className='flex flex-col w-full rounded-t-3xl'>
                <div className='w-full flex justify-end items-center rounded-t-3xl p-2'>
                  <div
                    className='bg-rose-400 cursor-pointer'
                    onClick={() => {
                      closeSiteContainer();
                    }}
                  >
                    <IoCloseOutline className='text-xl bg-blue-300' />
                  </div>
                </div>
                <div
                  id='site'
                  className={`h-full w-full bg-green-300 overflow-y-scroll noScrollBar rounded-b-3xl`}
                >
