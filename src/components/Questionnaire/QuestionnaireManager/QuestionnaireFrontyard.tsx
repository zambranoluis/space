...
interface QuestionnaireFrontyardProps {
  ...
  setAnswersFrontyard: React.Dispatch<React.SetStateAction<question[]>>;
...
const QuestionnaireFrontyard: React.FC<QuestionnaireFrontyardProps> = ({
  ...
  const questionRefsFrontyard = useRef<Array<HTMLDivElement | null>>(
  ...
  useEffect(() => {
    if (categories.includes("Backyard")) {
      if (
        ...
        setContainerHeightFrontyard(
          (prevHeight) =>
            prevHeight + questionRefsFrontyard.current![0]!.offsetHeight || 0
        );
        setTimeout(() => {
          if (sectionRefFrontyard.current) {
            window.scrollBy({
              top: sectionRefFrontyard.current.offsetHeight,
              behavior: "smooth",
            });
          }
        }, 100);
  ...
  useEffect(() => {
    const calculateContainerHeightFrontyard = () => {
      ...
      isAnsweredFrontyard.forEach((answered, index) => {
        ...
        if (answered && currentElement) {
          ...
          if (
            index + 1 < isAnsweredFrontyard.length &&
            !isAnsweredFrontyard[index + 1] &&
            nextElement
          ) {
    ...
    isAnsweredFrontyard,
    categories,
    questionRefsFrontyard.current.map((el) => el?.offsetHeight).join(","),
  ]);

  const handleControlText = (value: string, index: number) => {
    const newValue = value;
    setAnswersFrontyard((prev) =>
    ...
    <section
      ...
      className={`${
        !categories.includes("Backyard")
          ...
          ? ""
          : "hidden"
      } flex flex-col w-full justify-center items-center gap-20  bgred-200`}
    >
      <div
        ref={sectionRefFrontyard}
        className={`${
          !categories.includes("Backyard")
            ? isAnsweredGeneral[isAnsweredGeneral.length - 1] === true
              ? ""
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://github.com/BPM94/SCCTMD/raw/main/questionnaire/questionnaireBgFrontyard.webp",
          }}
        ></div>
      </div>
      <div
        ref={containerRefFrontyard}
        className={`${
          !categories.includes("Backyard")
            ? isAnsweredGeneral[isAnsweredGeneral.length - 1] === true
              ? ""
            ...
            ? ""
            : ""
        } flex flex-col w-[90%] gap-12 overflow-hidden`}
      ...
      >
        {answersFrontyard && isAnsweredFrontyard[0] === true ? (
          <div
            id="fq1"
            ref={(el) => {
              questionRefsFrontyard.current[0] = el;
            }}
            className={`${
              !categories.includes("Backyard")
                ? isAnsweredGeneral[isAnsweredGeneral.length - 1] === true
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq1Select"
                value={answersFrontyard[0].select === true ? "2" : "1"}
                onChange={(e) => {
        ...
        {answersFrontyard && isAnsweredFrontyard[1] === true ? (
          <div
            id="fq2"
            ref={(el) => {
              questionRefsFrontyard.current[1] = el;
            }}
            className={`${
        ...
        {answersFrontyard && isAnsweredFrontyard[2] === true ? (
          <div
            id="fq3"
            ref={(el) => {
              questionRefsFrontyard.current[2] = el;
            }}
            className={`${
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-center p-8 py-20">
              {questionnaire["backyard"][2].options.map((option, index) => (
                <div className="flex flex-col w-full " key={index}>
                  ...
                  <textarea
                    value={answersFrontyard[2].notes[index].note}
                    onChange={(e) => {
                      index === 0
                        ? handleControlDoubleText(e.target.value, 2, "keep")
                        : handleControlDoubleText(e.target.value, 2, "remove");
                    }}
                    className="bg-[#ebebeb] p-2 text-black outline-none h-[100px] fq3ThingsKeepRemove"
                  />
                </div>
              ))}
            </div>
        ...
        {answersFrontyard && isAnsweredFrontyard[3] === true ? (
          <div
            id="fq4"
            ref={(el) => {
              questionRefsFrontyard.current[3] = el;
            }}
            className={`${
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq4Select"
                value={answersFrontyard[3].select === true ? "2" : "1"}
                onChange={(e) => {
              ...
              <div className="flex flex-col w-full p-2">
                ...
                <textarea
                  id="fq4Note"
                  value={answersFrontyard[3].notes[1].note}
                  onChange={(e) => {
                    handleControlText(e.target.value, 3);
                  }}
                  className="bg-[#ebebeb] p-2 text-black outline-none h-[100px]"
                ></textarea>
              </div>
        ...
        {answersFrontyard && isAnsweredFrontyard[4] === true ? (
          <div
            id="fq5"
            ref={(el) => {
              questionRefsFrontyard.current[4] = el;
            }}
            className={`${
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq5Select"
                value={answersFrontyard[4].select === true ? "2" : "1"}
                onChange={(e) => {
              ...
              <div className="grid md:grid-cols-3 w-full gap-12">
                {questionnaire["backyard"][4].options.map((option, index) => (
                  <div
                    className={`${
                      index === 2 ? "hidden" : ""
                    }  flex flex-col gap-6 justify-center items-center text-black w-full bgblue-300`}
                    key={index}
                  >
                    <Image
                    ...
                    <div className="flex gap-6">
                      <p className="text-xs sm:text-base flex justify-center items-center gap-1 fq5WaterOption ">
                        <span className="text-xl  text-[#68664d]">▪ </span>
                        {option.name}
                      </p>
                      <input
                        type="checkbox"
                        checked={selectedWaterFrontyard.includes(index)}
                        onChange={() => {
              ...
              <div className="flex flex-col w-full p-2">
                ...
                <textarea
                  id="fq5Note"
                  value={answersFrontyard[4].notes[1].note}
                  onChange={(e) => {
        ...
        {answersFrontyard && isAnsweredFrontyard[5] === true ? (
          <div
            id="fq6"
            ref={(el) => {
              questionRefsFrontyard.current[5] = el;
            }}
            className={`${
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq6FireSelect"
                value={answersFrontyard[5].select === true ? "2" : "1"}
                onChange={(e) => {
              ...
              <div className="grid sm:grid-cols-2 w-full place-items-center max-sm:gap-8 place-content-center bgred-300 max-w-[500px] place-self-center">
                {questionnaire["backyard"][5].options.map((option, index) => (
                  ...
                  >
                    ...
                    />
                    <div className="flex gap-6">
                      <p className="text-xs sm:text-base flex justify-center items-center gap-1 fq6FireOption">
                        <span className="text-xl  text-[#68664d] ">▪ </span>
                        {option.name}
                      </p>
                      <input
                        type="checkbox"
                        checked={selectedFireFrontyard.includes(index)}
                        onChange={() => {
              ...
              <div className="flex flex-col w-full p-2">
                <div className="flex gap-2">
                  ...
                  <input
                    id="fq6FirePeople"
                    value={`${answersFrontyard[5].people}`}
                    onChange={(e) => {
                      handleControlPeople(parseInt(e.target.value), 5);
                    }}
                    className="w-[60px] outline-none border-none bg-[#ebebeb]  text-black pl-2"
                    type="number"
                  />
                </div>
                <div className="flex flex-col">
                  ...
                  <textarea
                    id="fq6FireNote"
                    value={answersFrontyard[5].notes[1].note}
                    onChange={(e) => {
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              ...
              <div className="flex flex-col w-full p-2">
                <div className="flex gap-2">
                  ...
                  <input
                    id="fq6FirePeople"
                    className="outline-none border-none bg-[#ebebeb] w-[60px] text-black pl-2"
                    type="number"
                  />
                </div>
                <div className="flex flex-col">
        ...
        {answersFrontyard && isAnsweredFrontyard[6] === true ? (
          <div
            id="fq7"
            ref={(el) => {
              questionRefsFrontyard.current[6] = el;
            }}
            className={`${
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq7Select"
                value={answersFrontyard[6].select === true ? "2" : "1"}
                onChange={(e) => {
              ...
              <div className="flex flex-col w-full p-2">
                ...
                <textarea
                  id="fq7Note"
                  value={answersFrontyard[6].notes[1].note}
                  onChange={(e) => {
        ...
        {answersFrontyard && isAnsweredFrontyard[7] === true ? (
          <div
            id="fq8"
            ref={(el) => {
              questionRefsFrontyard.current[7] = el;
            }}
            className={`${
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq8Select"
                value={answersFrontyard[7].select === true ? "2" : "1"}
                onChange={(e) => {
              ...
              <div className="flex flex-col w-full p-2">
                ...
                <textarea
                  id="fq8Note"
                  value={answersFrontyard[7].notes[1].note}
                  onChange={(e) => {
        ...
        {answersFrontyard && isAnsweredFrontyard[8] === true ? (
          <div
            id="fq9"
            ref={(el) => {
              questionRefsFrontyard.current[8] = el;
            }}
            className={`${
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq9Select"
                value={answersFrontyard[8]?.select === true ? "2" : "1"}
                onChange={(e) => {
              ...
              <div className="flex flex-col w-full p-2">
                ...
                <textarea
                  id="fq9Note"
                  value={answersFrontyard[8].notes[1].note}
                  onChange={(e) => {
        ...
        {answersFrontyard && isAnsweredFrontyard[9] === true ? (
          <div
            id="fq10"
            ref={(el) => {
              questionRefsFrontyard.current[9] = el;
            }}
            className={`${
          ...
          >
            ...
            <div className="flex flex-col gap-6 w-full justify-center items-start p-12 py-20">
              <select
                id="fq10Select"
                value={answersFrontyard[9].select === true ? "2" : "1"}
                onChange={(e) => {
              ...
              <div className="flex flex-col w-full p-2">
                ...
                <textarea
                  id="fq10Note"
                  value={answersFrontyard[9].notes[1].note}
                  onChange={(e) => {
