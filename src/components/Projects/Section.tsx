      ...
      <section className="w-[90%] py-8 flex flex-col  bgred-300 px-2 gap-8 sm:w-[80%] place-self-center">
        <div className="flex flex-col justify-center items-center text-[#6b776d]">
          <h1 className="font-black text-center">
            Hello, {customer?.name} {customer?.lastname}!
          </h1>
          <p className="text-center text-sm">
            Welcome to your Space Creations account, here you can share photos
            of yourspace, your inspiration and the measurements of your home.
          </p>
          ...
          <div className="flex flex-col py-6 gap-8 text-[#6c6c6c]">
            <div className="flex flex-col">
              ...
              <div className="flex bgblue-300 p-2 text-smin-[350px]sm:text-base">
                <p>
                  You have a call on{" "}
                  <span className="font-bold">December 15, 2023</span> at{" "}
                  <span className="font-bold">10:30am</span> pst time with one
            ...
            <div className="flex flex-col">
              ...
              <div className="flex bgblue-300 p-2 text-sm sm:text-base">
                <p>
                  You currently have an active package to design both areas of
                  your home (Front yard & BackYard).
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex flex-col   bgred-200" key={index}>
                  ...
                  >
                    {project.steps.map((step: any, indexStep: number) => (
                      ...
                      >
                        <div
                          className="flex place-self-start bgred-300 items-center p2 gap-2 font-bold cursor-pointer select-none"
                          onClick={() => {
                                ...
                                <div className="flex flex-col pl-2">
                                  <div className="flex flex-col">
                                    ...
                                    <div className="flex flex-col gap1 pl-2">
                                      {project.description.areas.map(
                                        (area: string, indexArea: number) => (
                                          <h2
                                            className="text-xs "
                                            key={indexArea}
                                          >
                          ...
                          <div>
                            {indexStep === 1 && (
                              <div className="flex flex-col gap-1 py-1">
                                {project.questionnaire.category.map(
                                  (category: string, indexCategory: number) => (
                                    <div
                                    ...
                                    >
                                      <Image
                                        className={`${
                                          category.isComplete ? "" : "hidden"
                                        } w-[20px] rounded-none bgred-200`}
                                ...
                                <div className="flex gap-2 justifycenter items-center text-sm">
                                  <Image
                                ...
                                <div className="pt-2n">
                                  <button
                                    ...
                                    onClick={() => {
                                      handleViewQuestionnaire(project._id);
                                    }}
                                  >
                                    View Questionnaire
                                  </button>
