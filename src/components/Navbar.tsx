...
const Navbar: React.FC<NavbarProps> = ( { toggleAside } ) => {
  ...
  return (
    ...
    <>
      <nav className="min-[900px]:hidden flex flex-col top-0 bg-black/50 w-full z-[1500] py-4 bgred-300 justify-between items-center px-6  ">
        <div id="navTop" className="flex justify-between items-center w-full ">
          <div id="logoNavbar" className="flex bgred-200">
            <Image className="h-full drop-shadow-[0_1.8px_1.8px_rgba(0,0,0,0.8)]"
              width={200}
              height={70}
          ...
          <div id="profileNavbar" className="flex justify-center items-center gap-2 text-[#8e7842] h-full bgred-300">
            <IoMdArrowDropdown className="text-2xl bgred-300 drop-shadow-[0_1.8px_1.8px_rgba(0,0,0,0.8)]" />
        ...
        <div id="navMid" className="flex select-none bggreen-300 py-4 px-4 bgred-200 px-2 w-full justify-between  items-center">
          <h1 className="text-[#69664c] text-2xl font-bold drop-shadow-[0_1.8px_1.8px_rgba(0,0,0,0.8)]">Projects</h1>
          <div id="iconsNavbar" className="flex justify-center items-center gap-4 ">
        ...
        <div id="navBottom" className="flex justify-center gap-8 items-center w-full ">
          <div id="searchNavbar" className="flex gap-3 sm:gap-6 bgblue-300 w-full max-w-[500px]">
      ...
      <nav className="max-[900px]:hidden flex top-0 bg-black/15 w-full z-[1500] h-[100px] bgred-300 justify-between items-center px-6  ">
        <div id="logoNavbar" className="flex bgred-200">
          <Image className="h-full drop-shadow-[0_1.8px_1.8px_rgba(0,0,0,0.8)]"
            width={200}
            height={70}
        ...
        <div id="searchNavbar" className="flex gap-3 sm:gap-6 bgblue-300 w-[250px]">
          <input className="outline-none  pl-6 py-2 px-2 bg-[#6c6c6c] text-black rounded-2xl w-full" type="text" placeholder="Project search..." />
        </div>
        <div id="iconsNavbar" className="flex justify-center items-center gap-4  bgred-300">
          <Badge className="bg-[#fe2f2f] border-0 drop-shadow-[0_1.8px_1.8px_rgba(0,0,0,0.8)]" content="" >
            <div className="w-[30px] bgred-300 h-[30px] flex justify-center items-center" >
              <FaCommentAlt className="text-xl text-[#6c6c6c] drop-shadow-[0_1.8px_1.8px_rgba(0,0,0,0.8)]" />
            </div>
