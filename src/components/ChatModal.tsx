...
const ChatModal = () => {
  ...
  <div className="flex flex-col gap-2">
    <div className="h[450px] w-[250px] maxh-0 overflow-hidden transition-all duration-300 ease-in-out bg-white bgred-300 rounded-3xl shadow-md shadow-black flex flex-col gap-2">
      <div className="flex justify-between px-8 py-2">
        ...
        <div className="flex justify-center items-center cursor-pointer bgred-300">
      ...
      <div className="w-[90%] bg-[#f3f3f3] h-[70%] place-self-center rounded-3xl p-4 overflow-y-scroll">
        ...
        <div className="h[70%] bgblue-300 text-black ">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam quam animi dolor, assumenda vitae eos facilis molestiae fuga libero reiciendis debitis porro, officiis impedit, recusandae corporis accusamus. Magnam, quo eum?
        </div>
      </div>
    ...
    <div className="bg-[#6c786e] p-4 rounded-full cursor-pointer flex place-self-end">
